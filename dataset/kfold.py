...
if __name__ == '__main__':
    types = ['DE', 'C0', 'T2']
    dataset_kfold(os.path.join(r'D:\PycharmProjects\pj_seg\data\MSCMR2019', types[2], 'npy/Labels'),
                  os.path.join(r'D:\PycharmProjects\pj_seg\data\MSCMR2019', types[2], 'npy'))
